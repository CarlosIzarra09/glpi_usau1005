...
class Line extends CommonDBTM
{
   // From CommonDBTM
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if($input['linetypes_id'] != 0 && LineType::getById($input['linetypes_id']) == false){
        ...
        else if($input['lineoperators_id'] != 0 && LineOperator::getById($input['lineoperators_id']) == false){

...
class Phone extends CommonDBTM
{
    ...
    */
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if($input['phonetypes_id'] != 0 && PhoneType::getById($input['phonetypes_id']) == false){
            array_push($selector_ids_incorrect,'phonetypes_id');
        }
        ...
        else if($input['phonemodels_id'] != 0 && PhoneModel::getById($input['phonemodels_id']) == false){
            array_push($selector_ids_incorrect,'phonemodels_id');
        }
        ...
        else if($input['phonepowersupplies_id'] != 0 && PhonePowerSupply::getById($input['phonepowersupplies_id']) == false){
            array_push($selector_ids_incorrect,'phonepowersupplies_id');
        }

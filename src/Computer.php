...
class Computer extends CommonDBTM
{
   ...
   ///Device container - format $device = array(ID,"device type","ID in device table","specificity value")
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if($input['computertypes_id'] != 0 && ComputerType::getById($input['computertypes_id']) == false){
            array_push($selector_ids_incorrect,'computertypes_id');
        }
        ...
        else if($input['computermodels_id'] != 0 && ComputerModel::getById($input['computermodels_id']) == false){
            array_push($selector_ids_incorrect,'computermodels_id');
        }
        else if($input['computermodels_id'] != 0 && ComputerModel::getById($input['computermodels_id']) == false){
            array_push($selector_ids_incorrect,'computermodels_id');
        }

...
class NetworkEquipment extends CommonDBTM
{
   ...
   // From CommonDBTM
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if($input['networkequipmenttypes_id'] != 0 && NetworkEquipmentType::getById($input['networkequipmenttypes_id']) == false){
        ...
        else if($input['networkequipmentmodels_id'] != 0 && NetworkEquipmentModel::getById($input['networkequipmentmodels_id']) == false){
            array_push($selector_ids_incorrect,'networkequipmentmodels_id');
        }

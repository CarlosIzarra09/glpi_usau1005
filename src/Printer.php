...
class Printer extends CommonDBTM
{
    ...
    */
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if($input['printertypes_id'] != 0 && PrinterType::getById($input['printertypes_id']) == false){
            array_push($selector_ids_incorrect,'printertypes_id');
        }
        ...
        else if($input['printermodels_id'] != 0 && PrinterModel::getById($input['printermodels_id']) == false){
            array_push($selector_ids_incorrect,'printermodels_id');
        }
        else if($input['snmpcredentials_id'] != 0 && SNMPCredential::getById($input['snmpcredentials_id']) == false){
            array_push($selector_ids_incorrect,'snmpcredentials_id');
        }
        else if($input['users_id'] != 0 && User::getById($input['users_id']) == false){
            array_push($selector_ids_incorrect,'users_id');
        }
        else if($input['networks_id'] != 0 && Network::getById($input['networks_id']) == false){
            array_push($selector_ids_incorrect,'networks_id');
        }

...
class Appliance extends CommonDBTM
{
   ...
   // From CommonDBTM
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if($input['appliancetypes_id'] != 0 && ApplianceType::getById($input['appliancetypes_id']) == false){
        ...
        else if($input['applianceenvironments_id'] != 0 && ApplianceEnvironment::getById($input['applianceenvironments_id']) == false){

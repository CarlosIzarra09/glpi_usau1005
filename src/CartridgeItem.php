...
class CartridgeItem extends CommonDBTM
{
   ...
   ///// SPECIFIC FUNCTIONS
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if($input['cartridgeitemtypes_id'] != 0 && CartridgeItemType::getById($input['cartridgeitemtypes_id']) == false){
            array_push($selector_ids_incorrect,'cartridgeitemtypes_id');
        }
